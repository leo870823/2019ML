...
def eva(model,filename,test_loader,best=False,distribution=False):
    if best:
...
if __name__ == "__main__":
    ...
    '''''
    #test
    Data_keeper_test=Preprocess( sys.argv[1], None)
    embedding=Data_keeper_test.Embedding_Word2Vector(True)
    ...
    eva(model,sys.argv[2],test_loader,best=True,distribution=False)
